...
#include "std_msgs/msg/int32.hpp"   // string 타입 메시지 사용
...
int main(int argc, char * argv[])
{
    ...
    // publisher 생성
    auto mypub = node->create_publisher<std_msgs::msg::Int32 >("topic_psub1",qos_profile);
    ...
    auto timer=node->create_wall_timer(50ms,fn);  // 1초마다 callback 함수 호출
